...
<%--                <td><a class="btn btn-outline-warning" href="/HangHoa?action=update&id=${h.id}">Sửa</a></td>--%>
                <td> <button type="button" class="btn btn-outline-warning" data-bs-toggle="modal"
                             ...
                             onclick="send('${h.idHangHoa}','${h.maHangHoa}')"> Xóa
                </button>
                </td>
            </tr>
        ...
        <td><a class="btn btn-outline-success" href="/HangHoa?action=create">Thêm Mới </a></td>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="/HangHoa?action=remove" method="post">
