    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link btn " data-bs-toggle="modal" data-bs-target="#exampleModal">Thêm mới nhân
                        viên</a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel2">Thêm mới nhân viên</h1>
    ...
    <c:forEach items="${list}" var="employee" varStatus="loop">
        <tr>
            ...
            <td><a class="btn btn-primary" role="button"
                   href="/nhan-vien-servlet?action=edit&id=${employee.idNhanVien}">Sửa</a>
            </td>
            <td>
