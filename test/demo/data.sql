...
INSERT INTO dich_vu_di_kem (ten_dich_vu_di_kem, gia_dich_vu_di_kem, id_loai_dich_vu) VALUES
    ...
    ('Bò Húc', 15.0, 1),
     ('Mỳ Hảo Hảo', 15.0, 2),
    ('Mỳ Thanh Long', 20.0, 2),
    ('Thuốc thăng long', 10.0, 3),
    ('Thuốc Mèo', 15.0, 3);
...
INSERT INTO su_dung_chi_tiet (id_dich_vu_di_kem, id_bang_su_dung, so_luong) VALUES
    ...
    select ten_may_tinh, mo_ta_tinh_trang from   may_tinh mt 
    left join tinh_trang tr on mt.ma_tinh_trang = tr.ma_tinh_trang
    left join tinh_trang_chi_tiet trct on tr.ma_tinh_trang = trct.ma_tinh_trang 