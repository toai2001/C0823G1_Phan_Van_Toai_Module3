...
public class BangSuDung {
    ...
    private long daDung;
    private Date gioBatDauDate;
    private Date gioKetThucDate;
    ...
    public void setGioBatDauDate(Date gioBatDauDate) {
        this.gioBatDauDate = gioBatDauDate;
    }

    public Date getGioBatDauDate() {
        return gioBatDauDate;
    }
    public void setGioKetThucDate(Date gioKetThuc) {
        this.gioKetThucDate = gioKetThuc;
    }

    public Date getGioKetThucDate() {
        return gioKetThucDate;
    }
    ...
    public BangSuDung(int idBangSuDung, LocalDateTime gioBatDau, LocalDateTime gioKetThuc, MayTinh maMayTinh, NhanVien maNhanVien,double tienDichVu, double tongTien, long daDung, boolean status) {
        this.idBangSuDung = idBangSuDung;
        this.gioBatDau = gioBatDau;
        this.gioKetThuc = gioKetThuc;
        this.maMayTinh = maMayTinh;
