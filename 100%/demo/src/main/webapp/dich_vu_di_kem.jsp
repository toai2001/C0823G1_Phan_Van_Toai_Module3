...
<h1 style="text-align: center;margin: 20px 0">Danh sách dịch vụ đi kèm</h1>
<table class="table table-hover" id="sidebar">
    <thead>
    <tr style="background-color: #4A5A6F;">
        <th style="color: white" scope="col">STT</th>
        <th style="color: white" scope="col">Tên Dịch Vụ Đi Kèm</th>
        <th style="color: white" scope="col">Giá dịch vụ đi kèm</th>
        <th style="color: white" scope="col">Loại dịch vụ</th>
    ...
    <c:forEach items="${listdvdk}" var="dvdk" varStatus="loop">
        <tr>
            ...
            <td><fmt:formatNumber value="${dvdk.giaDichVuDiKem}" type="currency" currencyCode="VND"/></td>
