    ...
    <div class="container-fluid" style="margin-top: 14px">
        ...
        <table class="table table-striped table-hover ">
            ...
            <c:forEach items="${mayChuaThue}" var="mayTinh">
                <tr>
                    <td><a style="text-decoration: none" href="/may-tinh-servlet?action=detail&id=${mayTinh.idMayTinh}"><i class="fa-solid fa-computer fs-2"> &nbsp</i>${mayTinh.tenMayTinh}</a>
                    </td>
