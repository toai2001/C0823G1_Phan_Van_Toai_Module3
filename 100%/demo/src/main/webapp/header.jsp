...
<head>
    ...
    <style>
        .dropdown-menu li a:hover {
            /*background-color: #FD7E37; !* Màu khi di chuột vào *!*/
            color: #4A5A6F; /* Màu chữ khi di chuột vào */
        }
    </style>
</head>
<!--HEADER-->
...
<nav style="background-color: rgb(74,90,111);height: 80px" class="navbar navbar-expand-lg">
    <div class="container-fluid">
        ...
        <div class="d-flex ms-auto" style="color:white;">
            <c:if test="${empty sessionScope.username}">
                <a style="color: white; font-size: 22px;" href="/login" type="button" class="btn btn-primary">Đăng nhập</a>
            </c:if>
            <c:if test="${not empty sessionScope.username}">
                <div class="dropdown"style=" color: white">
                    <a style="color: white"  href="#" name="userName" class="d-block  text-decoration-none dropdown-toggle"
